...
namespace EpilepsyMQTTObserver
{
    internal class Decoder
    {
        ...
        public static DecodedEcgMeasurement DecodeBytes(sbyte[] data)
        {
            ...
            DecodedEcgMeasurement decodedMeasurement = new DecodedEcgMeasurement()
            {
                DecodedEcgChannel1 = decoded_iECG1,
                DecodedEcgChannel2 = decoded_iECG2,
                DecodedEcgChannel3 = decoded_iECG3,
            };
